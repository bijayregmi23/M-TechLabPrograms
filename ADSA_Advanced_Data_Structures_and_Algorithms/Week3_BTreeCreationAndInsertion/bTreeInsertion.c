...
void amortisedCost(struct btreeNode *myNode)
{
        int count=myNode->count;
        int create=6;

        int addVal= 3*count+3;
        int splitVal= 8+MAX*3+ MIN;
        int setVal=6+MAX;
        ...
        int cost=create+addVal+splitVal+setVal+right+left+merge;
        printf("\nThe amortized cost is %d",cost );
}
